...
skill includes optional Seedance, Seedream, GPT Image 2, MiniMax H3 video, MiniMax Music and codex-imagegen (local codex
...
| `short-drama-produce` | Preview a bounded image/video/TTS/music job, require explicit confirmation, execute an external adapter, and record results; optional Seedance, Seedream, GPT Image 2, MiniMax H3 video, MiniMax Music and codex-imagegen profiles are included |
