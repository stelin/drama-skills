...
| STY-25 | taste_option | A whole-work emotion curve is an optional visualization the creator asks for: its nodes bind visible episode or scene IDs and its breathing zones and music emphases reuse node numbers; node count, peak position and intensity values are never a gate or a review basis. |
