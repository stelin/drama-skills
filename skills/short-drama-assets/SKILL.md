...
- 子女与父母、兄弟姐妹、不同演员承担的年龄阶段、变异形态、双胞胎/克隆、宿主与变身，在派生一方的人物条目写
  `派生自：人物「…」（继承：…；不继承：…）`、`派生关系` 与 `派生状态`；继承项只写 2–4 项跨造型稳定的骨相/体态锚点，
  上游没有定稿图前派生条目不算就绪，生产顺序按依赖层展开。
- 道具条目可写 `尺度：手持级 | 桌面级 | 家具级`；写了之后该道具的图片提示词正文必须带对应尺度短语。
...
- 血亲、年龄阶段、变异形态、双胞胎/克隆与生产顺序：[血缘与派生](references/kinship-and-derivation.md)
