...
- 子女像父母、兄弟姐妹彼此相像、人形与变异形态之间的连续，都不是造型版本，而是**派生**：
  一个人物条目的部分身份锚点来自另一个已确认条目。它们仍是不同人物，各自建条目，在派生一方
  写 `派生自` 声明，见 [血缘、派生与解锁顺序](kinship-and-derivation.md)。
- 双胞胎与克隆体同样是不同人物；它们是唯一允许高度相似的派生关系。
