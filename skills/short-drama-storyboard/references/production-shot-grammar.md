...
契约怎样声明、声明后哪些默认整体让位，见核心技能的《观看契约》（`SHT-26`）；声明为电影长片时，
本节、第五节「高度变化在竖屏里更贵」与第七节「子镜密度」一并不生效，建立镜头回到常规选项。
...
竖屏还有一条不能忽略（观看契约为横屏剧集或电影长片时本条回到横屏常规读法，不额外收紧）：**高度变化在竖屏里比横屏更贵**。9:16 的画面纵向本来就长，俯仰会
...
| 子镜密度 | （竖屏短剧默认；观看契约为电影长片或横屏剧集时本行不生效，`SHT-26`）9:16 信息流上的注意力是按切镜买的：`craft_default` 是可看的切镜密度大致每 4–8 秒一次，爽点更紧、情感处理更松在这条带宽内浮动，每次切换仍要有注意、压力或状态理由。项目把生成单元固定在更长的一档时，这条带宽由镜内调度承担——一镜里要有景别或视点的实际变化、或一次完整的动作与反应交接，否则无论单帧多好，观众读到的都是幻灯片。 |
